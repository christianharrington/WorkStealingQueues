...
root \texttt{Node} are combined, the entire array has been sorted. \todo{Explain why it does not work with idempotent queues}
...
when the root \texttt{Node} has been serialized. \todo{Explain why it does not work with idempotent queues}
